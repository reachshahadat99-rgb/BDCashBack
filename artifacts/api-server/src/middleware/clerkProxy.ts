/**
 * Clerk FAPI proxy middleware.
 * Re-exported from the canonical middleware/ directory.
 * All logic lives here; the old middlewares/clerkProxyMiddleware.ts now re-exports.
 */
